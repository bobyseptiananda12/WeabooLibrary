					...
					<div class="col s12 m12 l12 card-panel z-depth"> <br>
						<table class="highlight">
							...
							<?php 
			                    ...
			                    $sql = "SELECT * FROM users WHERE id LIKE '%$cari%' OR nik LIKE '%$cari%' OR nama LIKE '%$cari%' OR alamat LIKE '%$cari%' OR telepon LIKE '%$cari%' OR level LIKE '%$cari%'";
						...
						<table>
							<tr>
				            	<td colspan='9'>
				            		<a href='user.php' class="right waves-effect waves-light btn blue darken-2">KEMBALI</a>
				            	</td>
				            </tr>
						</table>
					</div>
