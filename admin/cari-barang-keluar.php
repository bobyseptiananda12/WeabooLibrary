					...
					<div class="col s12 m12 l12">
						<form name="cari" method="post" action="" class="row">
	                    	<div class="e-input-field col s12 m12 l12">
	                    		<input type="text" name="cari" placeholder="Masukkan ID / Jenis Inventory / Kode Barang / Nama Barang / Quantity" class="validate" required title="Cari User">
...
<?php 
			                    ...
			                    $cari = $_POST['cari'];	
			                    $sql = "SELECT * FROM gudang WHERE 
			                    jenis_inventory LIKE '%$cari%' OR
			                    kode_barang LIKE '%$cari%' OR nama_barang LIKE '%$cari%' OR quantity LIKE '%$cari%' OR  
			                    id LIKE '%$cari%'";
								...
								<th>Pengaturan</th>
			                        ...
			                        echo "<tr>";
			                    echo "<td>".$data['id']."</td>";
				                echo "<td>".$data['jenis_inventory']."</td>";
				                echo "<td>".$data['kode_barang']."</td>";
				                echo "<td>".$data['nama_barang']."</td>";
			                    echo "<td>".$data['quantity']."</td>"; 
			                    echo "<td>".$data['satuan']."</td>";  
			                        echo "<td>  <a href='edit-barang-keluar.php?id=$data[id]' style='text-decoration: none;'><i class='material-icons' title='Edit $test'>mode_edit</i></a> | <a data-id='1' class='hapus' href='delete-barang-keluar.php?id=$data[id]' style='text-decoration: none;'><i class='material-icons' title='Hapus $test'>delete</i></a> </td></tr>";
			                        echo "</table>";
			                      }else{
			                      	echo "<table>";
						...
						<table>
							<tr>
				            	<td colspan='9'>
				            		<a href='barangkeluar.php' class="right waves-effect waves-light btn blue darken-2">KEMBALI</a>
				            	</td>
				            </tr>
						</table>
					</div>
