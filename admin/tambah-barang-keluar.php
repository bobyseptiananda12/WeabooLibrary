	...
	<div class="row">
        ...
        <?php
          ...
          if(isset($_POST['tambah'])) {
            ...
            $result = mysqli_query($koneksi, "INSERT INTO barang_keluar(id,jenis_inventory,kode_barang,nama_barang,quantity,satuan) VALUES('$id','$jenis_inventory','$kode_barang','$name','$quantity','$satuan')");
            $result2 = mysqli_query($koneksi, "UPDATE gudang SET quantity = quantity - '$quantity' WHERE kode_barang = '$kode_barang'"); 
