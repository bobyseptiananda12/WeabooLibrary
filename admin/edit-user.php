...
{ 
  ...
  // update user data
  $result = mysqli_query($koneksi, "UPDATE users SET nik='$nik',nama='$name',alamat='$alamat',telepon='$mobile',level='$level' WHERE id=$id");
		            ...
		            <ul class="collapsible collapsible-accordion">
		                ...
		                <li>
		                	...
		                	<div class="collapsible-body">
		                		<ul><li><a href="gudang.php">Gudang</a></li>
