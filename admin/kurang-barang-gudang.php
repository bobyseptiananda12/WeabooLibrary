	...
	<div class="row">
					...
					<div class="col s12 m12 l12 card-panel z-depth"> <br>
						<table class="highlight">
							...
							<tr>
			                	...
			                	<th><input type="text" name="jenis_inventory" required></th>
			              	</tr>
							<tr>
				              <th>Kode Barang</th>
			              	...
			              	<tr>
			                	<th>Satuan</th>
			                	<th><input type="text" name="satuan" required></th>
			              	</tr>
						</table>
						<table>
				            <tr>
				            	<th>
				            		<input type="submit" name="kurang" value="Input Barang" class="right waves-effect waves-light btn green darken-2" style="float: left;">
				            	</th>
				            	<th style="width: 1%;">
        ...
        <?php
          ...
          if(isset($_POST['kurang'])) 
          {
            ...
            $result = mysqli_query($koneksi, "INSERT INTO barang_keluar(jenis_inventory,kode_barang,nama_barang,quantity,satuan) VALUES('$jenis_inventory','$kode_barang','$name','$quantity','$satuan')"); 
