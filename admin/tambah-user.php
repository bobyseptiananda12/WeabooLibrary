					...
					<div class="col s12 m12 l12 card-panel z-depth"> <br>
						<table class="highlight">
							<!--kolom isian table-->
								<th>NIK</th>
			                	<th>
			                	 <input type="text" name="nik" onkeypress="return event.charCode >= 48 && event.charCode <=57" required>
			                	</th>
				            <tr>
				              <th>Nama</th>
				            ...
				            <tr>
				              <th>Telepon</th>
				              <th><input type="number" name="telepon" required></th>
				            </tr>
				              <th>Username</th>
        ...
        <?php
          ...
          if(isset($_POST['tambah'])) {
            ...
            // Insert user data into table
             $result = mysqli_query($koneksi, "INSERT INTO users(nik,nama,alamat,telepon,username,password,level) VALUES('$nik','$name','$alamat','$telepon','$username','$password','$level')");
            if ($level == "Admin")
            {
            ...
            {
            	echo "<script>alert('Gagal Menambah User dengan NIK $nik')</script>";
            }
