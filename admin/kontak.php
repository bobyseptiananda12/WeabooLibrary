			...
			<div class="row container"> <br><br>
				    ...
				    <div class="col s12 m12 offset-l2 l12 ">
				        <div class="card-panel lighten-5 z-depth-1">
				          <div class="row valign-wrapper">
				            <div class="col s2">
				              <img src="../samuel2.jpg" height="100px"> 
				            </div>
				            <div class="col s12">
				              <span class="black-text">
				                Samuel Gunawan Martua Marbun
				              </span>
				            </div>
				            <div class="col s2">
				              <img src="../richard.jpg" height="100px"> 
				            </div>
				            <div class="col s12">
				              <span class="black-text">
				                Richard Ekin Prananta Surbakti
				              </span>
				    	...
				    	<div class="card-panel lighten-5 z-depth-1" >
				    		<div class="row valign-wrapper">
				    			<div class="col s2" align="center">
				    				<img src="../marzuq.jpg" height="100px">
				    			</div>
				    			<div class="col s12">
				    				<span class="black-text">
