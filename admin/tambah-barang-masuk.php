  	...
  	<div class="row">
          ...
          <?php
            ...
            if(isset($_POST['tambah'])) {
              ...
              $result = mysqli_query($koneksi, "INSERT INTO barang_masuk(jenis_inventory,kode_barang,nama_barang,quantity,satuan) VALUES('$jenis_inventory','$kode_barang','$name','$quantity','$satuan')");
