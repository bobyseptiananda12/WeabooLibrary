...
$result = mysqli_query($koneksi, "SELECT * FROM gudang ORDER BY id ASC");
					...
					<div class="col s12 m12 l12">
						<form name="cari" method="post" action="cari-digudang.php" class="row">
	                    	<div class="e-input-field col s12 m12 l12">
	                    		<input type="text" name="cari" placeholder="Masukkan Id / Jenis Inventory / Kode Barang / Nama Barang" class="validate" required title="Cari User">
					...
					<div class="col s12 m12 l12 card-panel z-depth"> <br>
						<table class="highlight">
							...
							while($user_data = mysqli_fetch_array($result)) { 
				                ...
				                echo "<tr>";
			                    echo "<td>".$id++."</td>";
				                echo "<td>".$user_data['jenis_inventory']."</td>";
				                echo "<td>".$user_data['kode_barang']."</td>";
				                echo "<td>".$user_data['nama_barang']."</td>";
			                  
			                    echo "<td>".$user_data['quantity']."</td>";
			                    echo "<td>".$user_data['satuan']
			                    	."</td>";   
				                 echo "<td> <a href='edit-gudang.php?id=$user_data[id]' style='text-decoration: none;'><i class='material-icons' title='Edit $test'>mode_edit</i></a> | <a data-id='1' class='hapus' href='delete-gudang.php?id=$user_data[id]' style='text-decoration: none;'><i class='material-icons' title='Hapus $test'>delete</i></a> </td></tr>";  
				            }
						...
						<table>
							<tr>
				            	<td colspan='9'>
				            		<a href='tambah-gudang.php' class="right waves-effect waves-light btn blue darken-2">Tambah Barang<i class="material-icons right">add</i></a>
				            	</td>
				            </tr>
						</table>
					</div>
