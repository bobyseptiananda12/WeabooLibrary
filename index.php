		...
		<div class="container">
			...
			<form method="POST" action="check-login.php">
				<div class="col s12 m12 l6 offset-l3 card-panel z-depth white">
					...
					<div class="row">
						<div class="center">
							<input name="login" type="submit" value="Masuk" class="modal-action modal-close btn blue darken-2">
							<input name="daftar" type="submit" value="Daftar" class="modal-action modal-close btn blue darken-2">
						</div>
                  	</div>
